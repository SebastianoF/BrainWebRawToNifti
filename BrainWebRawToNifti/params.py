...
# Paths. pfo = path to folder

pfo_root = '/my_data_folder/'  # set here the folder where the downloaded dataset is stored.
...
# Params - as they are specified on the BrainWeb website, do not modify.
